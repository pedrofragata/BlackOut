...
public class ZombieAI7 : MonoBehaviour
{
    ...
    void Update()
    {   
        if(thePlayer.transform.position.x < -27 && thePlayer.transform.position.x > -37 && thePlayer.transform.position.z > 67 && thePlayer.transform.position.z < 69)
        {
            isNear = true;
        }
